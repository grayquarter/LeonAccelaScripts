function sendNotification_UtilityRelease(inspTypeID) { // from Standard Choice EMSE:Utility_Releases
	var templateName = "UTILITY_RELEASE", templateParams = aa.util.newHashtable(), reportName = null, reportParams = aa.util.newHashMap(), reportModule = "Building";
...
*/
	...
	var utilityReleaseType = null, utilityReleaseTypeB = null;
	...
	*/
	...
	var emailFrom = "autosender@leoncountyfl.gov", emailTo = "", emailCC = "";
